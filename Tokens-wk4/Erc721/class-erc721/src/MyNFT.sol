...
/// @notice Deliberately does NOT inherit ERC721Enumerable — most collections
///         don't need on-chain enumeration (indexers/subgraphs cover it), and
///         skipping it avoids paying the extra SSTOREs on every transfer.
///         Swap the parent to ERC721Enumerable if you actually need it on-chain.
